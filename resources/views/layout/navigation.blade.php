<nav class="navbar navbar-main navbar-expand-lg border-radius-xl mx-3 px-0 shadow-none" id="navbarBlur" data-scroll="true">
    <div class="container-fluid px-3 py-1">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb me-sm-6 mb-0 me-5 bg-transparent px-0 pb-0 pt-1">
                ...
                <li class="breadcrumb-item text-dark active text-sm" aria-current="page">Template</li>
            </ol>
        </nav>
            ...
            <ul class="navbar-nav d-flex align-items-center justify-content-end ms-auto">
                {{-- <li class="nav-item d-flex align-items-center">
                    <a class="btn btn-outline-primary btn-sm mb-0 me-3"
                        href="https://www.creative-tim.com/builder?ref=navbar-material-dashboard" target="_blank">Online
                        Builder</a>
                </li>
                <li class="mt-1">
                ...
                <li class="nav-item d-xl-none d-flex align-items-center ps-3">
                    <a class="nav-link text-body p-0" id="iconNavbarSidenav" href="javascript:;">
